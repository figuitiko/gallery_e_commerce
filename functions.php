...
load_template( trailingslashit( get_template_directory() ) . 'includes/cpt/expos.php' );
/*
 * woocommerce
 *
 */
load_template( trailingslashit( get_template_directory() ) . 'includes/woocommerce.php' );
